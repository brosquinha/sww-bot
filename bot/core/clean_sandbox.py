...
__version__ = '$Id: 597b0a2bee1226bbffebde842225bac3c6c8094a $'
#
...
content = {
	...
	'pt': u'Olá {{USERNAME|usuário}}. Bem-vindo à \'\'\'página de testes\'\'\' da \'\'[[Star Wars Wiki]]\'\'. Aqui você pode testar seus códigos ou qualquer outra coisa à vontade. Só lembre-se de que de tempos em tempos esta página é esvaziada, então não espere que suas edições durem muito tempo aqui. Divirta-se!\n'
		  u'\n'
		  u'<div style="text-align:center;">[http://pt.starwars.wikia.com/wiki/Star_Wars_Wiki:Testes?action=edit&section=new <span class="button">Teste suas edições!</span>]</div>\n'
		  u'[[Categoria:Star Wars Wiki]]\n'
		  u'----',
