...
#
__version__ = '$Id: 611bd9070b168c392ed41f1a27d10e22a4a5f864 $'
#
...
comment = {
	...
	'pt': u'([[User:Thales César|Thales]]) Marcação de imagens para eliminação',
}
...
template_to_the_image = {
	...
	'pt': u'{{Apagar|Imagem não utilizada}}',
}
...
except_text = {
	...
	'pt': u'<table id="mw_metadata_mentira" class="mw_metadata">',
}
#MODIFIQUEI O PT EM except_text PARA EVITA-LO...
...
def main(*args):
	...
	bot = UnusedFilesBot(swwsite, **options)
	try:
		bot.run()
